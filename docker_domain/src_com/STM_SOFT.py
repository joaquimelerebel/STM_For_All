...
def main():
    ...
    parser.add_argument("-exp", "--exponential",
                        action="store_true",
                        help="does scale the sim output exponentialy")
    ...
    parser.add_argument("-fr", "--frequence", type=int,
                        help="line rate in Hz (default 100Hz)")

    parser.add_argument("-v", "--verbose", action="store_true",
                        help="print all the inner messages of the processing")
    parser.add_argument("-f", "--filter", type=str,
                        help="filter type applied on the final image")
